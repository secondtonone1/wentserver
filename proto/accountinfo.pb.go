...
type GenerateUid struct {
	Generateuid          int64    `protobuf:"varint,1,opt,name=generateuid,proto3" json:"generateuid,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *GenerateUid) Reset()         { *m = GenerateUid{} }
func (m *GenerateUid) String() string { return proto.CompactTextString(m) }
func (*GenerateUid) ProtoMessage()    {}
func (*GenerateUid) Descriptor() ([]byte, []int) {
	return fileDescriptor_c818053d22c59a62, []int{3}
}
func (m *GenerateUid) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GenerateUid) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GenerateUid.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *GenerateUid) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GenerateUid.Merge(m, src)
}
func (m *GenerateUid) XXX_Size() int {
	return m.Size()
}
func (m *GenerateUid) XXX_DiscardUnknown() {
	xxx_messageInfo_GenerateUid.DiscardUnknown(m)
}

var xxx_messageInfo_GenerateUid proto.InternalMessageInfo

func (m *GenerateUid) GetGenerateuid() int64 {
	if m != nil {
		return m.Generateuid
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*GenerateUid)(nil), "proto.GenerateUid")
}
...
var fileDescriptor_c818053d22c59a62 = []byte{
	...
	0x20, 0x64, 0x65, 0x4a, 0xfa, 0x5c, 0xdc, 0xee, 0xa9, 0x79, 0xa9, 0x45, 0x89, 0x25, 0xa9, 0xa1,
	0x10, 0x0f, 0xa4, 0x43, 0xb9, 0xa5, 0x70, 0x0f, 0x22, 0x0b, 0x39, 0x09, 0x9c, 0x78, 0x24, 0xc7,
	0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x33, 0x1e, 0xcb, 0x31, 0x24, 0xb1, 0x81,
	0xad, 0x30, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x39, 0x31, 0x39, 0xc4, 0x44, 0x01, 0x00, 0x00,
}
...
func (m *GenerateUid) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GenerateUid) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Generateuid != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintAccountinfo(dAtA, i, uint64(m.Generateuid))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *GenerateUid) Size() (n int) {
	...
	_ = l
	if m.Generateuid != 0 {
		n += 1 + sovAccountinfo(uint64(m.Generateuid))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *GenerateUid) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GenerateUid: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GenerateUid: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Generateuid", wireType)
			}
			m.Generateuid = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Generateuid |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
